...
const ProfilePage = ({
    ...
    return (
      <div>
        <div className="max-w-6xl flex items-center h-auto flex-wrap mx-auto my-32 lg:my-20">
          <div className="w-full rounded-lg shadow-2xl bg-white mx-6 lg:mx-0">
            <div className="p-4 md:p-14 text-center">
              ...
              <div className="mt-6 pb-10 w-full mx-auto flex flex-wrap items-center justify-center">
                <div>
