        ...
        <div className="w-96">
            {blog.published ? (
              <div className="md:flex-shrink-0 relative">
                <div className="z-10 mt-1 flex flex row text-gray-500 text-2xl absolute cursor-pointer mx-3 bottom-10 right-5">
                  {(user.username === username) ? (
                    <div className="flex flex-row">
                      ...
                      <MdEdit className="text-xl mt-2 cursor-pointer" onClick={()=>updateBlog(blog.slug)}/>
                      <MdDelete className="text-xl mt-2 cursor-pointer" onClick={()=>destroyBlog(blog.slug)}/>
                    </div>                    
                  ):(
                    null
                  )}                    
