...
export default function RelatedBlogs({data,blogDetails,showBlog,updateBlog,destroyBlog}) {
    console.log('blog details',blogDetails)
    console.log('related blog length',data.length)
    const blogDetails_id = blogDetails.id
    return (
    <div>
        <div className='text-lg ml-12 font-bold text-gray-700'>
            {(data.length > 0) ? (
